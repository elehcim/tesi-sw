...
root/
  ...
  |-MissionAnalysis/	Scripts for various computations for preliminarlily design a Mission to Jupiter
  |-Plot_ftle/		Scripts to visualize FTLE fields from output files generated by FTLE_CPU
  |-README.txt				
