...
% In this approach, every different point is stored in the array, no
% matter if it is useful for the ftle computation.

%Points with complex velocity are stored, but not integrated (check is in
%the RK4 function
