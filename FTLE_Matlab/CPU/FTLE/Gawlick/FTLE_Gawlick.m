...
RelTol=1e-12;AbsTol=1e-12; % A caso
...
%options='';
%% Integration
[ x_T, y_T, vx_T, e_T, filter, delta_e ] = Integrate_FTLE_Gawlick( x_0, y_0, vx_0, e_0, T, mu, options);
...
%% Compute FTLE
[ ftle, dphi ] = Compute_FTLE_Gawlick( x_T, y_T, vx_T, e_T, dx, dy, dvx, de, T, filter_ftle);
