function [ x_T, y_T, vx_T, e_T, filter, delta_e ] = Integrate_FTLE_Gawlick( x_0, y_0, vx_0, e_0, T, mu, options)
%Integrate
%   This function performs Runge-Kutta (ODE45) integration for given
